...
tag to tell browsers to render the gaps.
      ...
      <ol id="wd-your-favorite-recipe">
        <li>Prep chocolate for brownies.</li>
        <li>Add sugar.</li>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="images/teslabot.jpg" alt="project pic" height="200px" />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
      ...
      Please
      <a id="wd-github" href="https://github.com/cliffdawg/kanbas-react-web-app"> go to Github repo </a>
      <br/>
