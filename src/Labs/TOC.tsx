  ...
  return (
    <ul className="nav nav-pills">
      ...
      <li className="nav-item">
        <a id="wd-github" href="https://github.com/cliffdawg" className="nav-link">
          My GitHub
        </a>
      </li>
      <li className="nav-item">
        <a id="wd-github-server" href="https://github.com/cliffdawg/kanbas-node-server-app" className="nav-link">
          My Server GitHub
        </a>
      </li>
      <li className="nav-item">
        <a id="wd-render" href="https://kanbas-node-server-app-bhmi.onrender.com/" className="nav-link">
          My Render
        </a>
      </li>
      <li className="nav-item">
